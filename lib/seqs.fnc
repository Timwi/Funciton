                ...
                └─╢ 0 ╟─╢   ├─┤ ? ╟─────────┘                ║      : •[e, 0]             ║  ┌─┤   ├─┘   │       │ ╓───╖
                  ╚═╤═╝ ╚═╤═╛ ╘═╤═╝                          ╚════════════════════════════╝  │ │ ╔═╧═╕ ┌─┴─╖     ├─╢ ʬ ╟─┐
                    └─────┘     │                                                            │ └─╢   ├─┤ ? ╟─────┘ ╙───╜ │
                                                                                             │   ╚═╤═╛ ╘═╤═╝             │
     ╔═════════════════════════════╗           ╔═════════════════════════════════════╗       │   ╔═╧═╗   │               │
     ║  first index of element     ║           ║  last index of element              ║       │   ║ 0 ║                   │
     ║  (or −1 if not found)       ║           ║  (or −1 if not found)               ║       │   ╚═══╝                   │
     ╟─────────────────────────────╢           ╟─────────────────────────────────────╢       └───────────────────────────┘
     ║  ⋉(q, e) = ⋉p(q, e, 0)      ║           ║  ⋊(q, e) = ⋊p(q, e, 0)              ║
     ╟─────────────────────────────╢           ╟─────────────────────────────────────╢
     ║  ⋉p(q, e, i) =              ║           ║  ⋊p(q, e, i) =                      ║
     ║    let (h, t) = q(0);       ║           ║    let (h, t) = q(0);               ║
     ║    let n = ⋉p(t, e, ♯(i));  ║           ║    let n = ⋊p(t, e, ♯(i));          ║
     ║    q ? h = e ? i : n : −1   ║           ║    q ? n = −1 & h = e ? i : n : −1  ║
     ╚═════════════════════════════╝           ╚═════════════════════════════════════╝
                   ┌──────────┐                                ┌──────────┐
           ╔═══╗ ┌─┴──╖ ╓───╖ │                        ╔═══╗ ┌─┴──╖ ╓───╖ │
           ║ 0 ╟─┤ ⋉p ╟─╢ ⋉ ╟─┘                        ║ 0 ╟─┤ ⋊p ╟─╢ ⋊ ╟─┘
