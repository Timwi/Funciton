...
╔═══════════════════════════════════════════════════════════════════════════╗
║  Returns a lazy sequence repeating one, two or three values indefinitely  ║
╟─────┬─────────────────────────────────────────────────────────────────────╢
║  1  │  ⁞(x) = let f = λ_·[x, f]; f                                        ║
║  2  │  ⸗(x, y) = let f = λ_·[x, λ_·[y, f]]; f                             ║
║  3  │  ≡(x, y, z) = let f = λ_·[x, λ_·[y, λ_·[z, f]]]; f                  ║
╚═════╧═════════════════════════════════════════════════════════════════════╝
                                                                  ╓───╖
     ╓───╖          ┌──────────────────┐                      ┌───╢ ≡ ╟─┐
     ║ ⁞ ║          │            ╓───╖ │                    ┌─┴─╖ ╙─┬─╜ │
   ...
   └───┴──┐           ╚═╤═╛  ╚═╤═╛                   ╚═╤═╛  ╚═╤═╛       │
          │             └──────┴──┐             ┌─┐  ╔═╧═╕    │         │
                                  │             └─┴──╢   ├────┴──┐      │
                                                     ╚═╤═╛       │      │
 ╔════════════════════════════════════╗                └────────────────┘
 ║  Infinite sequence of consecutive  ║
 ║  integers starting at x            ║     ╔═════════════════════════════╗
 ╟────────────────────────────────────╢     ║  Sequence of n consecutive  ║
 ║  ♪(x) = λ_·[x, ♪(♯(x))]            ║     ║  integers starting at x     ║
 ╚════════════════════════════════════╝     ╟─────────────────────────────╢
                 ╓───╖                      ║  ♫(x, n) = n ? λ_·[x,       ║
                 ║ ♪ ║                      ║       ♫(♯(x), ¬♯(¬n))] : 0  ║
                 ╙─┬─╜                      ╚═════════════════════════════╝
