...
{
    /// <summary>
    ///     Represents an edge (line) coming out of an <see cref="UnparsedNode"/> before the parser has determined where it
    ///     connects to. Once the parser has determined that, see <see cref="Edge"/>.</summary>
